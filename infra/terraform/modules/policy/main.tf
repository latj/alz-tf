...
resource "azurerm_management_group_policy_assignment" "mcsb" {
  ...
  management_group_id  = local.management_group_scope
...
resource "azurerm_management_group_policy_assignment" "require_team_tag" {
...
resource "azurerm_management_group_policy_assignment" "inherit_team_tag" {
...
resource "azurerm_management_group_policy_assignment" "activity_log_diag" {
...
resource "azurerm_role_assignment" "inherit_env_tag" {
  ...
  principal_id                     = azurerm_management_group_policy_assignment.inherit_env_tag.identity[0].principal_id
...
resource "azurerm_role_assignment" "inherit_team_tag" {
  scope                            = local.management_group_scope
  role_definition_name             = "Tag Contributor"
  principal_id                     = azurerm_management_group_policy_assignment.inherit_team_tag.identity[0].principal_id
  skip_service_principal_aad_check = true
}
...
resource "azurerm_role_assignment" "activity_log_diag_law" {
  ...
  principal_id                     = azurerm_management_group_policy_assignment.activity_log_diag.identity[0].principal_id
  skip_service_principal_aad_check = true
}
