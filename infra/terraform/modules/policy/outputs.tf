output "policy_assignment_ids" {
  ...
  value = {
    ...
    require_env_tag      = azurerm_management_group_policy_assignment.require_env_tag.id
    require_team_tag     = azurerm_management_group_policy_assignment.require_team_tag.id
...
output "policy_assignment_names" {
  ...
  value = {
    mcsb                 = azurerm_management_group_policy_assignment.mcsb.name
    allowed_locations    = azurerm_management_group_policy_assignment.allowed_locations.name
    allowed_locations_rg = azurerm_management_group_policy_assignment.allowed_locations_rg.name
    require_env_tag      = azurerm_management_group_policy_assignment.require_env_tag.name
    require_team_tag     = azurerm_management_group_policy_assignment.require_team_tag.name
